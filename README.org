...
** How to read Event Loop&Modules
...
*** 5. while pageNumber < bookLength, set pageNumber=pageNumber+chunkSize, go back to 3. else continue to 6.
*** 6. call onExit method (cleanup, parting thoughts)
...
** Narrate Submode: 
*** todo use ? https://github.com/coqui-ai/TTS ? to generate voice to narrate gpt response&queries to user
...
also naive/correct pronounciation sounds kind of like pizza, which is typically
